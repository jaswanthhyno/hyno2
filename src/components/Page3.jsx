...
const [info1,setInfo1]=useState("Andriod")
  ...
  <p  style={{fontFamily:"Work Sans",fontSize:"18px",color:"#FF004C",marginBottom:"20px"}}>Client</p>
  ...
  <div style={{marginLeft:"200px",width:"400px",height:"400px",marginTop:"50px",fontWeight:"lighter",fontFamily:"Raleway, Medium"}}>
    <p style={{fontFamily:"Gilroy-Regular",fontSize:"18px",color:"#FF004C"}}>Goals</p>
